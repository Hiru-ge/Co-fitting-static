# プロジェクト概要:Co-fitting-static

コーヒーの味を維持したまま、出来上がり量を変化させる変換器です。

## 2025/05/05追記:正式リリース版「Co-fitting」を公開しました！

正式リリース版である「Co-fitting」を公開しました。
バックエンド処理を追加し、各ユーザーが自分用の「マイプリセット」を登録できるようになっています！
以下のリンクから使用していただければ幸いです！

[Co-fitting](https://co-fitting.com/)

なお、Co-fittingのリポジトリは以下になります。

https://github.com/Hiru-ge/Co-fitting
...
本リポジトリのファイルをローカルに引っぱって個々で利用することも可能ですし、アップグレード版「[Co-fitting](https://co-fitting.com)」をブラウザで使用することもできます。
